...
// zero ghost layers
#define NXG0	(nxGlobal_d)
#define NYG0	(nyGlobal_d)
#define NZG0	(nzGlobal_d)
// one ghost layer
#define NXG1	(nxGlobal_d + 2)
#define NYG1	(nyGlobal_d + 2)
#define NZG1	(nzGlobal_d + 2)
// two ghost layers
#define NXG2	(nxGlobal_d + 4)
#define NYG2	(nyGlobal_d + 4)
#define NZG2	(nzGlobal_d + 4)
// four ghost layer
#define NXG4	(nxGlobal_d + 8)
#define NYG4	(nyGlobal_d + 8)
#define NZG4	(nzGlobal_d + 8)
